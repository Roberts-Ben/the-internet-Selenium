...
public class BasePage
{
    ...
    public BasePage(WebDriver driver)
    {
        ...
        pattern = Pattern.compile("\\.(jpg|png|txt|json|xlsx|pdf|mp4|zip|py|exe|docx|jpeg|csv|sol|tmp|java|doc|class|bin|mov|xml|bmp|webp|rtf)$", Pattern.CASE_INSENSITIVE);
    }
